        ...
        FilamentView::registerRenderHook(
            ...
            function () {
                if (request()->routeIs('filament.app.pages.certificate-designer')) {
                    ...
                    return Blade::render('
                        @vite(["public/css/custom-sidebar-topbar.css", "public/js/filament/konvaScript.js", "public/js/filament/placeDataInCanvas.js", "public/js/filament/manualDataEntry.js"])
                    ');
                }
            }
        );
